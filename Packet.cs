...
{
    /// <summary>
    /// Packet identifier for packet sent from server to client
    /// </summary>
    ...
    /// <summary>
    /// Packet identifier for packet sent from client to server
    /// </summary>
    ...
    public class Packet : IDisposable
    {
        ...
        //public const int HeaderSize = 4 * sizeof(uint);
        //public const int DataSize = PacketSize - HeaderSize;
        ...
        /// <summary> Create a new packet with a header </summary>
        //public Packet(uint protocolId, uint sequence, uint packetType)
        //{
        //    Write(protocolId);
        //    Write(sequence);
        //    Write(packetType);
        ...
        /// <summary> Create a packet out of a received byte array </summary>
